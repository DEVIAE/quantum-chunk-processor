...
title Quantum Chunk Processor - Spring Boot Workers
echo ========================================
echo   Quantum Chunk Processor
echo   Spring Boot 3.2.4 + KEDA Autoscaling
...
echo   Requisitos:  ActiveMQ Artemis + Redis
echo ========================================
echo.
...
:: ========================================
echo ======================================== >> "!LOG_FULL!"
echo   Quantum Chunk Processor - Inicio: %date% %time% >> "!LOG_FULL!"
echo ======================================== >> "!LOG_FULL!"

set "PS_SCRIPT=%TEMP%\quantum-processor-run.ps1"
(
...
echo.
echo [INFO] Chunk Processor detenido. Log guardado en !LOG_FULL!
pause
